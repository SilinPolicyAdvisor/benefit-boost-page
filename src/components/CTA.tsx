...
const CTA = () => {
  return <section className="py-20 bg-gray-900 text-white relative overflow-hidden">
      {/* Background elements */}
      ...
      <div className="container mx-auto px-6 lg:px-8 relative">
        <div className="max-w-4xl mx-auto text-center space-y-8 animate-fade-in">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center pt-8">
            <Button size="lg" className="bg-brand-blue hover:bg-blue-600 text-white px-12 py-6 text-lg font-semibold rounded-lg shadow-2xl hover:shadow-blue-500/25 transition-all duration-300 hover:scale-105">
              Schedule Your Call
            </Button>
            <Button variant="outline" size="lg" className="border-2 border-white hover:bg-white px-12 py-6 text-lg font-semibold rounded-lg transition-all duration-300 backdrop-blur-sm text-zinc-950">
              View Our Tools
            </Button>
          </div>
